# Wedding Anniversary Interactive Page

A fun, interactive Wedding Anniversary page where the "Yes" button grows bigger every time they click "No" — with falling hearts, cute GIFs, music, and playful toast messages. Built with pure HTML, CSS, and JavaScript.


# Inspiration Gotten from SahilGogna 
